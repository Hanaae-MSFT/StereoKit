...
namespace StereoKit
{
	...
	public static class Renderer
	{
        ...
        /// <inheritdoc cref="Renderer.RenderCustom(Action)"/>
        /// <param name="customRenderingCode"> executes custom rendering code.</param>
        public static void RenderCustom(Action customRenderingCode = null) => NativeAPI.render_add_custom_code(customRenderingCode);
